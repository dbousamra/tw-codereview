...
1. Not a huge amount of visibility around whether there is code needing to be reviewed.
2. Handle on the code isn't always great - occasionally wrong code sent out, sometimes problem statement is omitted.
